...
La troisième analyse s'intéresse à Les populations classes ayant terrestres strictement terrestres et celles dont le mode de vie est aquatique sont différentes dans la mesure où les facteurs qui les influencent les altérent sont de nature différentes. Par exemple, les animaux animaux aquatiques sont suceptibles de réagir à des variations des propriétes de l'eau telles la concentration en oxygène et la température[@mallik_management_2025], ce que l'on peut observer notamment chez les poissions d'élevage par exemple, et d'ingérer des microplastiques dissous[@trevisan_nanoplastics_2022], là où ceux qui sont typiquement terrestres devraient être davantage affectés par des facteurs tels que l'altération des habitats par l'activité humaine,tel la conversion des habitats terrestres[@august_human_2002]. De fait, pour cette section de l'analyse de tendance l'intérêt sera de **tester la supposition selon laquelle il y a une divergence dans les variations des populations selon leur milieu de vie**.
